...
LOCAL_PATH="/work/FAC/FGSE/IDYST/tbeucler/downscaling/fquareng/data/DA/8h-PS-RELHUM_2M-T_2M"

# File to store the list of selected files
FILE_LIST="/work/FAC/FGSE/IDYST/tbeucler/downscaling/fquareng/data/DA/8h_files_151719.txt"
...
# rsync -avz -e "ssh -J $REMOTE_USER@$FRONTEND_HOST" $REMOTE_USER@$REMOTE_HOST:/users/fquareng/selected_files.txt $FILE_LIST
...
# Step 4: Extract the "T_2M,RELHUM_2M,PS" variable and save as new files
cd $LOCAL_PATH
while read file; do
