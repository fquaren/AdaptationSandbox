...
metrics["finetuning"] = {}
metrics["finetuning"] = compute_metrics(metrics["finetuning"], base_path="/Users/fquareng/experiments/finetuning", n_clusters=8)
...
metrics["interpolation"]["linear"]["Error"] = metrics["interpolation"]["linear"]["mse"]
...
metrics["interpolation"]["quadratic"]["Error"] = metrics["interpolation"]["quadratic"]["mse"]
...
metrics["interpolation"]["cubic"]["Error"] = metrics["interpolation"]["cubic"]["mse"]
...
plt.scatter(mse_values["finetuning"], error_values["finetuning"], color='g', label='Finetuning', alpha=1, marker="o", s=100)
