...
if __name__ == "__main__":
    ...
    for cluster_dir in cluster_dirs:
        ...
        input_dir = os.path.join("/work/FAC/FGSE/IDYST/tbeucler/downscaling/fquareng/data/DA/1d-PS-RELHUM_2M-T_2M_cropped_gridded_clustered_threshold_12", cluster_dir)
        output_dir = os.path.join("/work/FAC/FGSE/IDYST/tbeucler/downscaling/fquareng/data/DA/1d-PS-RELHUM_2M-T_2M_cropped_gridded_clustered_threshold_12_blurred_zarr", cluster_dir)
